  ...
  // RatedPower Case Study
  {
    ...
    approach: [
      ...
      },
      {
        ...
        description:
          '**Joined customer calls** with Sales and CS to hear frustration firsthand. Contacted clients who had requested the feature to understand their current painful workflows. **Maintained a group of 4-5 power users** for ongoing validation.',
      },
      {
