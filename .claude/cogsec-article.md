...
Author: [Affaan Mustafa](https://x.com/affaanmustafa)  
Original article: <https://x.com/affaanmustafa/article/2012378465664745795>

![Header image](https://pbs.twimg.com/media/G-1nccYaoAATrW2?format=jpg&name=medium)
...
[Sep 16, 2025](https://x.com/affaanmustafa/status/1967797706757394906): took the W at the [@AnthropicAI](https://x.com/AnthropicAI) x [@forumventures](https://x.com/forumventures) hackathon in NYC thanks for hosting guys was a great event (and for the 15k in Anthropic Credits). [@DRodriguezFX](https://x.com/DRodriguezFX) and I built PMFProbe to take founders from 0 -> 1, validate your idea at the pre MVP stage more to come soon.

![Hackathon photo 1](https://pbs.twimg.com/media/G08FlQKXwAA8mso?format=jpg&name=small)
![Hackathon photo 2](https://pbs.twimg.com/media/G08FlQfW0AAsqgb?format=jpg&name=900x900)
![Hackathon photo 3](https://pbs.twimg.com/media/G08FlQIXEAEJP-t?format=jpg&name=900x900)
![Hackathon photo 4](https://pbs.twimg.com/media/G08FlQVXsAAaQkP?format=jpg&name=small)
...
![Chaining commands together](https://pbs.twimg.com/media/G-0-_fZagAA9Kqk?format=jpg&name=medium)
...
![PostToolUse feedback example](https://pbs.twimg.com/media/G-1Gwvab0AM7Xr9?format=png&name=small)

Example of what feedback you get in Claude Code, while running a PostToolUse hook. Pro tip: Use the `hookify` plugin to create hooks conversationally instead of writing JSON manually. Run /hookify and describe what you want.
...
1. Single: [CLAUDE.md](https://claude.md/) - Everything in one file (user or project level)  
...
![Supabase MCP example](https://pbs.twimg.com/media/G-1KHqfawAA-PPK?format=jpg&name=medium)
...
![MCP status in plugins](https://x.com/affaanmustafa/article/2012378465664745795/media/2012346906828259328)
...
![Mixedbread-Grep marketplace](https://pbs.twimg.com/media/G-1Loo1bYAAI_tz?format=jpg&name=medium)
...
![Claude approving a bug fix PR](https://pbs.twimg.com/media/G-1U7nSbAAAK7hf?format=jpg&name=medium)
...
![Zed Editor commands dropdown](https://pbs.twimg.com/media/G-1Cy8gbAAA2fE-?format=jpg&name=medium)
...
![VS Code docs](https://pbs.twimg.com/media/G-1b3F_aMAApve3?format=jpg&name=medium)
...
![Status line example](https://pbs.twimg.com/media/G-1iYlHaEAAbS0C?format=jpg&name=medium)
...
Here's the repository with every configuration from the article. Contributions are welcome and I will be reviewing PR's: <https://github.com/affaan-m/everything-claude-code>
